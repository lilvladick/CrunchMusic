...
INSERT INTO news (title, news_content, author_id, category_id, is_breaking) VALUES
('Прорывы в искусственном интеллекте 2024', 'Искусственный интеллект проникает во все сферы жизни, revolutionizing пользовательский опыт и автоматизируя сложные задачи.', 1, 1, true),
('Расширение сетей 5G и их влияние', 'Сети 5G становятся более распространенными, трансформируя отрасли здравоохранения, транспорта и образования.', 2, 1, false),
('Умные кольца и носимые устройства', 'Умные кольца и другие носимые устройства предлагают продвинутые возможности отслеживания здоровья и управления умными домашними устройствами.', 3, 1, true),
('Геотермальная энергетика и устойчивое развитие', 'Новые технологии бурения геотермальных систем обеспечивают стабильную и чистую энергию с минимальным воздействием на окружающую среду.', 1, 1, false);